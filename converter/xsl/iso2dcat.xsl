...
-->
    ...
    <xsl:template match="gmd:MD_RestrictionCode[@codeListValue!='otherRestrictions']" mode="license">
        <dct:license>
            <xsl:choose>
...
<!--
    <xsl:template match="gmd:MD_RestrictionCode[@codeListValue!='otherRestrictions']" mode="accessRights">
        <dct:accessRights>
            <xsl:choose>
                <xsl:when test="$openNRW!='true' or (@codeListValue!=$c_license and ../../gmd:accessConstraints/*/@codeListValue!=$c_license)">
    ...
    <xsl:template match="gmd:resourceConstraints/*/gmd:accessConstraints/*[@codeListValue!='license' and @codeListValue!='otherRestrictions']/@codeListValue">
        <dct:rights>
            <xsl:call-template name="rightsStatement">
